...
export default function ProgressCircle({percentage, isPlaying, size, color, image}) {
  ...
  return <div className='progress-circle flex'>
    <svg width={size} height={size}>
      <g>
        <Circle strokeWidth={'0.4rem'} color='#E7E2CC' size={size} />
      ...
      <image className={isPlaying ? 'active': ''} x={30} y={30} width={2*((size/2) - 30)} height={2*((size/2) - 30)} href='https://pngimg.com/uploads/vinyl/vinyl_PNG107.png' clipPath='url(#myCircle)' />
